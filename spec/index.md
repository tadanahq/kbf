...
(what every business shares) sits under layered core playbooks (what a
...
it extends, and what version of the spec it targets.
...
5. [`playbook-format.md`](playbook-format.md): how the primitives above are
   laid out on disk into a playbook.
...
- [`examples/cafe-demo`](../examples/cafe-demo) (`extends:
  ...
  studio, one worked example per core chain. Each exercises every
...
Every YAML example in this spec is copied from one of these five playbooks
